...
import { PasswordResetConfirmSchema, PasswordResetConfirmSchemaType } from "@/validators/schemas/auth";
import { usePasswordResetConfirm } from "@/data/endpoints/auth";
        ...
        <CardContent>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 px-3">
              ...
              <SubmissionButton label="Reset Password" isSubmitting={isSubmitting}  />
